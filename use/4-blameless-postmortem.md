...
| | |
| :--- | :--- |
| **Goal** | Improve the system, not judge the person. Honesty is mandatory. |
...
| **Work-as-done** | What did the operator actually do that was not in the runbook? That gap is a defect in the runbook. |
...
| **Owner** | One named person, one due date, tracked somewhere real. |
